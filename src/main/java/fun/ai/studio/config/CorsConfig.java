...
public class CorsConfig {
    ...
    public CorsFilter corsFilter() {
        ...
        if (patterns == null || patterns.isBlank()) {
            patterns = "http://localhost:5173,http://127.0.0.1:5173,http://172.17.9.149:5172,https://funar.funshion.com,https://*.funshion.com,https://studioclient.fun.tv,https://*.fun.tv";
        }
