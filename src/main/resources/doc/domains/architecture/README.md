...
**图解**：
- 用户通过三种路径访问系统：业务 API、开发预览、线上应用
- API (91) 是协调中心，转发请求到 Workspace (87) 或 Deploy (100)
- Runner (101) 从 Git (103) 拉代码，构建后部署到 Runtime (102)
- 应用容器连接独立的 Mongo 存储数据
