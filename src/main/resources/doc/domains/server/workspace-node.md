...
# - 对应 application-prod.properties：server.tomcat.basedir=${FUNAI_TOMCAT_BASEDIR:/data/funai/tomcat-workspace}
Environment="FUNAI_TOMCAT_BASEDIR=/data/funai/tomcat-workspace"
